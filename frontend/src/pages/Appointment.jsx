...
const Appointment = () => {
  ...
  const fetchDocInfo = useCallback(async () => {
    if (!doctors || doctors.length === 0) {
      await getDoctorsData(); // Refresh doctors list if empty
      return; // Wait for next render after doctors are loaded
    }
    ...
    setDocInfo(docInfo);
  }, [doctors, docId, getDoctorsData, navigate]);
  ...
  return (
    docInfo && (
      <div>
        ...
        {/* Booking Slots */}
        <div className="sm:ml-12 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button
            ...
            className="text-white bg-[#5f6FFF] px-14 py-3  my-6 rounded-full text-sm font-light "
          >
            Book an Appointment
          </button>
        </div>
